...
const AddItem: React.FC = () => {
  ...
  const handleGenerateQuestions = async () => {
    ...
    try {
      ...
      setFounderAnswers(new Array(generatedQuestions.length).fill(''));
      setStep(2);
    } catch (err) {
    ...
    <div className="step-content">
      <div className="step-header">
        ...
        <div>
          ...
          <p className="step-description">
            Answer these questions about the item you found
          </p>
        </div>
      </div>
      ...
      <div className="questions-info">
        <div className="info-box">
          ...
          The person who lost this item will need to answer the same questions to verify ownership.
        </div>
      </div>
    ...
    <div className="step-content">
      ...
      <div className="summary-box">
        ...
        <div className="summary-grid">
          ...
          <div className="summary-item">
            <strong>Questions:</strong> {questions.length} answered
          </div>
        </div>
      </div>
